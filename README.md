...
- **6835 termes** canoniques (français/anglais) — 100.0% documentés, 100.0% définis
- **48 chaînes causales** et **0 renvois** inter-documents
- **256 fiches conceptuelles** et **192 prompts** structurés
- **10 pages web** interactives (calculateurs, cartographie, triangle des textures)
- **52 tables** SQLite, 143 scripts Python
